...
Größe des jeweiligen Schrittes:\footnote{Die
  ...
  inkorrekt. Der dort gelistete „larger diatonic semitone“ ist mit $133.24\ct$
  kaum noch als Halbton zu erkennen und daher unserer Überzeugung nach in den
...
\item \emph{Großer chromatischer Halbton}\\
  ...
  kleiner.\looseness-1
\item \emph{Diatonischer Halbton}\\
...
Zusätzlich zu diesen fünf harmonisch begründbaren Schritten wollen wir noch das
\emph{Limma} -- den pythagoreischen diatonischen Halbton -- erwähnen, da dieser
in melodisch gedachten Passagen (siehe \cref{sec:balance}) eingesetzt wird. Um
die unsere die Größe der Schritte berücksichtigende Nummerierung nicht
kaputtzumachen, quetschen wir ihn zwischen 2 und 3:
...
\item[2\pazofrac12.] \emph{Limma} (griechisch „Überrest“)\\
  ...
  aber an melodisch gedachten Stellen, z.\,B. wenn in einer Tonleiter nur große
  Ganztöne verwendet werden. Wie schon in \cref{sec:pythInt} festgestellt
  entspricht er dem Verhältnis $243:256$ und hat die Größe $90{,}22\ct$.
\end{enumerate}
