...
\begin{enumerate}
  ...
  \item Herzchenakkord?\todo{Über den habe ich septimal noch nicht lange
    nachgedacht. Aber wenn man ihm eine septimale Intonation zuweisen möchte ist
    es sicherlich die von diminished7 nur dass die \flat $5$ auch septimal so
    alteriert wird, dass der Durdreiklang rein ist, oder? TD}
\end{enumerate}
