...
‚$\nearrow$‘ einer reinen kleinen Terz entspricht.
...
von darauf angewandten syntonischen Kommata entspricht. Diese Anzahl der
...
Kommahöhe, wenn sie in der gleichen „Zeile“ des Tonnetzes stehen.\todo{Ist das
  verständlich? Ich würde ja gern von der „Kommahöhe eines Tones“ sprechen, aber
  streng logisch ist in diesem Absatz ist ein Ton etwas, auf das man Kommata
  anwenden kann, nicht etwas, das schon Syntonisierungsinformation
  enthält. Dafür aber so einen Begriff wie „Helmhholtz-Ellis-Ton“ oder so
  einzuführen, erschien mir dann ein bisschen \emph{overkill}. FK}
