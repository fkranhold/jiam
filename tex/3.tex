...
(Subdominantparallele, oder \textsc{ii} in der Stufentheorie)\todo{Ich verstehe
  nicht warum wir hier und \emph{nur} hier Stufenbezeichnungen benutzen. Das
  erscheint mir relativ inkonsistent; vllt. übersehe ich aber auch einfach den
  Grund. TD} und der zweite als Quinte von G-Dur (Dominante, oder \textsc{v}) – 
