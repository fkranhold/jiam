...
Dokuments angegeben sind\LY{m-4567} (hier ist ein erstes Beispiel, in dem ein
...
diese Webanwendung, die alle in diesem Skript behandelten (nicht gleichstufigen)
Intervalle ausrechnen kann:
\begin{quote}
