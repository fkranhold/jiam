...
%% Content 3
ZS = \relative c'' { a2   b    cP1 }
ZA = \relative c'' { cP,2 d    cP1 }
ZT = \relative c'  { e,2  fP   e1  }
ZB = \relative c   { a2   gisM a1  }

%% Content 4
AS = \relative c'' { a2   b      cP1 }
AA = \relative c'' { cP,2 \oS dS cP1 }
AT = \relative c'  { e,2  fPS    e1  }
AB = \relative c   { a2   gisM   a1  }
