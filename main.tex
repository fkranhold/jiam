...
among these four simultaneously sounding notes is given by\looseness-1
...
\item Even in the Pythagorean system, triads are not optimally tuned, e.g.\ a
  ...
  base frequency).
\item \todo{change that.} Even within the Euler lattice, a major triad with
...
\end{enumerate}
This approach differs from the standard literature\todo{Welche?} in two aspects:
